...
UINT32 g_u32InaccuracyKHz = 0;
void sysCheckPllConstraint(BOOL bIsCheck)
{
	bIsCheckConstraint = bIsCheck;
}
void sysClockInaccuracy(UINT32 u32InaccuracyKHz)
{
	g_u32InaccuracyKHz = u32InaccuracyKHz;
}
...
==================================================*/  
void sysClockDiv(register UINT32 u32SysDiv)
{
...
==================================================*/  
void sysClockDivSwitchStart(UINT32 u32SysDiv)
{
	UINT32 vram_base, aic_status = 0;
    VOID    (*wb_func)(UINT32);
